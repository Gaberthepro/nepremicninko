...
#define MagickLibVersion  0x70B
#define MagickLibVersionText  "7.0.11"
#define MagickLibVersionNumber  9,0,0
#define MagickLibAddendum  "-3"
#define MagickLibInterface  9
#define MagickLibMinInterface  9
#define MagickPlatform  "x86_64"
#define MagickppLibVersionText  "7.0.11"
